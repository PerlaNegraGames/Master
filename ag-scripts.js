window['sEcFFDcqbK2SH5kLzlLGB'] = true;
...
})({"args":["navigator.getBattery","noopPromiseResolve"],"engine":"extension","name":"set-constant","verbose":false,"domainName":"https://jugapro.web.app/admin/gh","version":"4.3.0"}, ["navigator.getBattery","noopPromiseResolve"]);
...
})({"args":[],"engine":"extension","name":"no-topics","verbose":false,"domainName":"https://jugapro.web.app/admin/gh","version":"4.3.0"}, []);
(function setConstant(source, args) {
  var flag = "done";
  var uniqueIdentifier = source.uniqueId + source.name + "_" + (Array.isArray(args) ? args.join("_") : "");
  if (source.uniqueId) {
...
})({"args":["navigator.privateAttribution","undefined"],"engine":"extension","name":"set-constant","verbose":false,"domainName":"https://jugapro.web.app/admin/gh","version":"4.3.0"}, ["navigator.privateAttribution","undefined"]);
...
})({"args":[],"engine":"extension","name":"no-protected-audience","verbose":false,"domainName":"https://jugapro.web.app/admin/gh","version":"4.3.0"}, []);
